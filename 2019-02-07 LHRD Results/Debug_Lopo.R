...
#---- Condition on 1 ----
pdata = LeaveOnePatientOut(model_data,patient,c(2,4,6,8))
pdata$ID = patient
...
matplot(pdata$times_test, t(p_2$C_pred[sample(1:100,50),]), type = 'l', col = 'black', lty = 'dashed')
points(pdata$times_test, pdata$C_hat_test)
lines(pdata$times_test, apply(p_2$C_pred,2,mean), col = 'red')
