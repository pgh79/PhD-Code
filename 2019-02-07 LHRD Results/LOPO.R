...
test_patient = 1
test_time = 00
no_condition_on = (times> test_time) & (patient_ID==test_patient)
...
patient_ID_train = as.numeric(as.factor(unique(patient_ID[!no_condition_on]) ) )
...
train_names = c('C_hat_train','times_train', 'X_train','N_train','D', 'patient_ID_train')
